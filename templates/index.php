...
<div style="width: 100%;">
  <iframe data-token-url="/index.php/apps/signaturepdf_nextcloud/onetime_webauth_token" id="iframe_pdf" src="https://pdf.24eme.fr/<?php p($_['signaturepdf_url']) ?>#dav:<?php p($_['pdf']); ?>" style="height: 100%; width: 100%"></iframe>
</div>
