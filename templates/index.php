...
<div style="width: 100%;">
  <iframe data-token-url="/index.php/apps/signaturepdf_nextcloud/onetime_webauth_token" id="iframe_pdf" src="http://signaturepdf:9000/metadata#dav:<?php p($_['pdf']); ?>" style="height: 100%; width: 100%"></iframe>
</div>
