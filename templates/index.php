...
<div style="width: 100%;">
  <iframe data-token-url="/index.php/apps/signaturepdf/onetime_webauth_token" id="iframe_pdf" src="<?php p($_['signaturepdf_url']) ?>#dav:<?php p($_['pdf']); ?>" style="height: 100%; width: 100%"></iframe>
</div>
